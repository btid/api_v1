...
class Unauthorized extends AbstractHandler
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response)
    {
        if ($request->getMethod() === 'OPTIONS') {
            ...
            $output = $this->renderPlainUnauthorizedOutput();
        } else {
            ...
            switch ($contentType) {
                ...
                case 'text/html':
                    $output = $this->renderHtmlUnauthorizedOutput($request);
                    break;
     ...
     * @return string
     */
    protected function renderPlainUnauthorizedOutput()
    {
        return 'Unauthorized';
    }
    ...
    {
        return Json::getJsonPatent()->encodeJson(Json::getJsonPatent()->generateErrorCode(401));
    }
    ...
    {
        return '<root><message>Unauthorized</message></root>';
    }
     ...
     * @return string
     */
    protected function renderHtmlUnauthorizedOutput(ServerRequestInterface $request)
    {
        return <<<END
<html>
    <head>
